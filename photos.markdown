...
<div class="flex flex-col md:flex-row group py-2 relative min-h-24 border-b border-sky-900/50">
  <div class="md:mr-4 shrink-0 self-center w-64">
  ...
  <div class="flex flex-col">
    <h4 class="text-lg font-bold text-gray-900 dark:text-white mt-0 md:mt-6 not-prose">
...
I also have one "professional" photo credit to my name so far as the last photo in:
